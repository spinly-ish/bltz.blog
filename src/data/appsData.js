/**
 * appsData.js — Централизованная база данных приложений
 * 
 * ES6 Module версия (ранее использовала window.appsData)
 * 
 ...
 * @param {number|string} id - ID приложения
...
/**
 * Список категорий для Sidebar (фиксированный порядок)
 */
